...
mvn archetype:generate -B -DarchetypeGroupId=com.archetypes -DarchetypeArtifactId=archetype-zipkin -DarchetypeVersion=0.0.1-SNAPSHOT -DgroupId=com.micro -DartifactId=yourzipkinid -Dversion=0.0.1-SNAPSHOT
